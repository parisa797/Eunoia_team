          ...
          onPress={() => {
             console.log(user);
              ...
              if(pass.lenght == 0)alert("please enter your password");
                ...
                if(confpass.lenght == 0)alert("please conferm your password");
                else{
                  if(eml.lenght == 0)alert("please inter vaild email");
                  else{
                }
              }
            }
            ...
            // fetch
            fetch("http://192.168.1.106:8000/rest-auth/registration/", {
              method: "POST",
              headers: {
              ...
              .then((response) => {
               ...
               if(response.status == 200)
                  ...
                  else alert("please choose anouther username or password is too short");
