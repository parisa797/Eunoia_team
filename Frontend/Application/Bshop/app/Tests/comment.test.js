...
describe("testing comment", () => {
  it("renders correctly", () => {
    ...
    const tree = renderer.create(
      <Comment navigation={{ push }} route={{ params }} />
    );
    ...
    const comments = [
      {
        user: {
          urls: [
            {
              uploaded_file: "parisaZ.jpg",
            },
          ],
          user_name: "parisa",
        },
        text: "من از فروشگاه خیلی راضیم!",
        date_jalali: "1400-03-06 19:04:26.637765",
        id: 0,
      },
      {
        user: {
      ...
      },
      {
        ...
        text: "من خیلی از خریدم راضی نبودم والا",
