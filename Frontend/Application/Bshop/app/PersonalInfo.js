...
const PersonalInfo = (props) => {
  console.log("in edit info", props);
  ...
  return (
    <ScrollView nestedScrollEnabled={true}>
      <View style={styles.koli}>
        <View style={styles.aksprof}>
          {image && (
            // <Image source={{ uri: image }} style={{ width: 200, height: 200 }} />
            <Avatar.Image size={200} source={{ uri: image }} />
          )}
          <TouchableOpacity style={styles.Btn} onPress={pickImage}>
            <Text style={styles.Btntxt}>انتخاب عکس </Text>
          </TouchableOpacity>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.kenareham}>
            <TouchableOpacity style={styles.Btn} onPress={() => UpdateInfo()}>
              <Text style={styles.Btntxt}>ذخیره اطلاعات </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.Btn} onPress={() => SureDelete()}>
              <Text style={styles.Btntxt}>حذف حساب کاربری </Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
