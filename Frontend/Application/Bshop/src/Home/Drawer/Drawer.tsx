...
const items: DrawerItemProps[] = [
  { icon: "zap", label: " نمایش فروشگاه ها", screen: "OutfitIdeas", color: "primary" },
  { icon: "user", label: "ویرایش حساب کاربری", screen: "EditProfile", color: "drawer1" },
  { icon: "log-out", label: "خروج از حساب کاربری", 
      ...
      <Box flex={0.8}>
        ...
        >
          ...
          <Box marginVertical="m">
            <Text variant="title1" textAlign="center">Robo Shop</Text>
          </Box>
