    ...
    return (<div className="all-shops-list-container">
        {!!newest && newest.length > 0 && <>
            ...
            <div data-testid="myshops" style={{ width: "100%", direction: "rtl"/*, position: "absolute", top: "200px", left: "0px"*/, zIndex: "1", margin: "0 0 5vh 0" }}  >
                <ItemsList url={"/items/newest"} items={newest} listType="horizontal" itemHolderClass="col-12 col-sm-4 col-md-3 col-lg-2" />
            </div>
        </>
        }
        ...
        <div data-testid="shops" style={{ width: "100%", direction: "rtl"/*, position: "absolute", top: "200px", left: "0px"*/, zIndex: "1", margin: "0" }}  >
            <ItemsList url={"/items/discounted"} items={discounted} listType="horizontal" itemHolderClass="col-12 col-sm-4 col-md-3 col-lg-2" />
        </div>
        </>
        }
        ...
        <div data-testid="region-shops" style={{ width: "100%", direction: "rtl"/*, position: "absolute", top: "200px", left: "0px"*/, zIndex: "1", margin: "0" }}  >
            <ItemsList url={"/items/category?=Fruits and vegetables"} items={thisCategoryItems} listType="horizontal" itemHolderClass="col-12 col-sm-4 col-md-3 col-lg-2" />
        </div>
        </>
        }
    </div>)
