...
function EditShop(props) {
    ...
    const [proLogo, setProLogo] = useState("./../profile.png");
    ...
    useEffect(() => {
        ...
        fetch("http://127.0.0.1:8000/api/v1/shops/user/", {
            ...
            response => {
                ...
                if(!prof.logo)
                    prof.logo = "url(../public/profile.png)";
                if(!prof.picture)
                    prof.picture = "url(../public/profile.png)";
                if(!prof.online)
                    prof.online = false;
                            ...
                            <div className="row">
                                <div className=" form-group input-container col-12 col-md-6">
                                    ...
                                    <input id="prof-page-fname" type="text" className="input" value={title} data-testid="edit-shop-title" maxLength={20}
                                        onFocus={() => { /*setEdit(true);*/ if (title === "عنوان فروشگاه را وارد کنید...") setTitle("") }}
                                        onChange={(e) => setTitle(e.target.value)}
                                        onBlur={(e) => {/*checkIsChanged(0, e.target.value, profile.FirstName);*/ if (!e.target.value) setTitle(profile.title); }}
                                    />
                                </div>
                                <div className=" form-group input-container col-12 col-md-6">
                                    ...
                                    <input id="prof-page-shop-phone" type="text" className="input" value={shop_phone} data-testid="edit-shop-shop-phone" maxLength="11"
                                        ...
                                        onFocus={() => { /*setEdit(true);*/ if (shop_phone[0] !== "0") setShopPhone("0") }}
                                ...
                                <div className=" form-group input-container col-12 col-md-6">
                                    ...
                                    <input id="prof-page-lname" type="text" className="input" value={manager} data-testid="edit-shop-manager" maxLength={20}
                                        onFocus={() => { /*setEdit(true);*/ if (manager === "نام مدیر فروشگاه را وارد کنید...") setManager("") }}
                                        onChange={(e) => setManager(e.target.value)}
                                        onBlur={(e) => { /*checkIsChanged(1, e.target.value, profile.LastName);*/ if (!e.target.value) setManager(profile.manager) }}
                                    />
                                </div>
                                <div className=" form-group input-container col-12 col-md-6">
                                ...
                                <div className="checkbox-prof col-12">
                                    <input id="prof-page-online" type="checkbox" data-testid="edit-shop-checkbox" defaultChecked={online} onChange={()=>setOnline(!online)} />
