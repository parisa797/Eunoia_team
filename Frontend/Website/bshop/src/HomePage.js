                ...
                <div className="header-content">
                    <div style={{ alignSelf: "center" }}>
                        ...
                        <div className="searchbar" >
                            ...
                            <div style={{ paddingTop: "5vh" }}><a href="/maps" style={{ fontSize: "larger", color: "var(--font-color2)" }}>...یا فروشگاه موردنظر خود را از روی نقشه پیدا کنید<LocationOnIcon className="icon" /></a></div>
                        </div>
