...
function Shop(props) {
    const [board, setBoard] = useState([{ image: "./../../special-offer.jpg" }, { image: "./../../Info-Yalda-PR-4.gif" }, { image: "./../../پیشنهاد-ویزه-وجین-Copy.jpg" }])
    const [shopInfo, setShopInfo] = useState({}) //phone ro dorost kon
    ...
    return (
        <div className="shop-page">
            ...
            <div className="page-contents">
                    ...
                    <div className="shop-profile">
                        <div className="shop-info">
                            ...
                            <div className="rating-comment">
                                {shopInfo.rate_value && <><p style={{ direction: "ltr" }} data-testid={"shop-rate-value"}>امتیاز: {Math.round(shopInfo.rate_value * 10) / 10}  </p>
                                    <ReactStars
                ...
                <div className="page-contents-item">
                    {/* <div className="btn edit-info" onClick={()=>window.location.href+="/edit-info"}>ویرایش اطلاعات<EditIcon /></div> */}
                    ...
                    {userState === "m" && <a className="edit-board" href="">{board.length === 0 ? "بورد شما خالی است. ساخت بورد" : "ویرایش بورد"}</a>}
                </div>
