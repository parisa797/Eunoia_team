                                ...
                                if (item)
                                    return (
                                        <div key={"all-items" + i} data-testid={"shop-all-items-" + i} className="col-12 col-sm-6 col-md-4 col-lg-3">
                                            <ItemCard item={item} id={"all-items-"+item.id} showDeleteItemModal={props.showDeleteItemModal} userState={props.userState}/>
                                        </div>
                                    )
                            })}
                                ...
                                if (item)
                                    return (
                                        <div key={"discount-items" + i} className="col-12 col-sm-6 col-md-4 col-lg-3">
                                            <ItemCard item={item} id={"discount-items-"+item.id} showDeleteItemModal={props.showDeleteItemModal} userState={props.userState}/>
                                        </div>
                                    )
                            })}
                            <div className="see-more" >
                                ...
                                if (item)
                                    return (
                                        <div key={"popular-items" + i} className="col-12 col-sm-6 col-md-4 col-lg-3">
                                            <ItemCard item={item} id={"loved-items-"+item.id} showDeleteItemModal={props.showDeleteItemModal} userState={props.userState} />
                                        </div>
                                    )
                            })}
                            <div className="see-more" >
