...
class Profileserializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MyUser
        fields = ['files', 'urls', 'FirstName', 'LastName', 'user_name', 'role',
                  'phone', 'address', 'pass_word', 'email', 'id', 'longitude', 'latitude']
...
class RestProfileserializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MyUser
        fields = ['files', 'urls', 'FirstName', 'LastName', 'username', 'role',
                  'phone', 'address', 'password', 'email', 'id', 'longitude', 'latitude']
