...
urlpatterns = [
    ...
    path('users/profile/coins/<pk>/update',
         CoinUpdate.as_view(), name="coin_update"),
    path('users/shopping-with-coins/special-item/<int:pk>',
         ShoppingWithCoinListCreate.as_view(), name="coin_shop"),
    path('users/shopping-with-coins/shopping-list/list/',
         ShoppingWithCoinListList.as_view(), name="list_coin_shop"),
    path('users/shopping-with-coins/shopping-list/<int:pk>',
         ShoppingWithCoinListRetrieve.as_view(), name="retrieve_coin_shop"),
