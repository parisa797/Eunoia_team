...
urlpatterns = [
    ...
    path('comment/create/', views.CommentCreateAPIView.as_view(), name="CommentCreate"),
    path('comment/list/<int:pk>', views.CommentListAPIView.as_view(), name="CommentList"),
    path('comment/<int:pk>', views.CommentRetrieveUpdateDestroyAPIView.as_view(), name="CommentRetrieveUpdateDestroy"),
    ...
    path('rate/<int:pk>', views.RateRetrieveUpdateDestroyAPIView.as_view(),name="RateRetrieveUpdateDestroy"),
