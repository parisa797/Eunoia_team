...
class CreateShopTest(APITestCase):
    ...
    def test_create(self):
        ...
        self.user5 = MyUser.objects.create_user(
            username='test 5', email='test5@test.com', password="strong_Pass")
        self.invalid_shop_3 = {
            'title': 'shop 1',
            'user': self.user5.id,
            'manager': 'manager 1',
        ...
        self.user1 = MyUser.objects.create_user(
            username='test 1', email='test1@test.com', password="strong_Pass")
        ...
        self.user4 = MyUser.objects.create_user(
            username='test 4', email='test4@test.com', password="strong_Pass")
        ...
        self.user2 = MyUser.objects.create_user(
            username='test 2', email='test2@test.com', password="strong_Pass")
        ...
        self.user3 = MyUser.objects.create_user(
            username='test 3', email='test3@test.com', password="strong_Pass")
...
class AllShopListTest(APITestCase):
    ...
    def test_list_all_shop(self):
        test_user = MyUser.objects.create(
            username="name 1", email="zmahmoudzadeh78@gmail.com", password="password1234")

        sh1 = Shop.objects.create(title="shop 1", user=test_user, manager="manager 1",
                                  logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")
        sh2 = Shop.objects.create(title="shop 2", user=test_user, manager="manager 2",
                                  logo=None, address="address 2", theme=1, shomare_sabt="2222", phone="222222")
        sh3 = Shop.objects.create(title="shop 3", user=test_user, manager="manager 3",
                                  logo=None, address="address 3", theme=1, shomare_sabt="2222", phone="333333")
...
class ShopRetrieveTest(TestCase):
    ...
    def test_retrieve_single_shop(self):
        response = client.get(
            reverse('ShopRetrieveAPIView', kwargs={'pk': self.sh1.pk}))
    ...
    def test_get_invalid_single_shop(self):
        response = client.get(
            reverse('ShopRetrieveAPIView', kwargs={'pk': 50}))
...
class ShopUpdateTest(APITestCase):
    ...
    def test_update_shop(self):
        self.user11 = MyUser.objects.create_user(
            username='test 11', email='test11@test.com', password="strong_Pass")
...
class ShopDeleteTest(APITestCase):
    ...
    def test_delete(self):
        ...
        self.user12 = MyUser.objects.create_user(
            username='test 12', email='test12@test.com', password="strong_Pass")
        ...
        self.user13 = MyUser.objects.create_user(
            username='test 13', email='test13@test.com', password="strong_Pass")
...
class ShopListUser(APITestCase):
    ...
    def test_list_user_shop(self):
        ...
        sh1 = Shop.objects.create(title="shop 1", user=self.user12, manager="manager 1",
                                  logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")
        sh2 = Shop.objects.create(title="shop 2", user=self.user11, manager="manager 2",
                                  logo=None, address="address 2", theme=1, shomare_sabt="2222", phone="222222")
        sh3 = Shop.objects.create(title="shop 3", user=self.user11, manager="manager 3",
                                  logo=None, address="address 3", theme=1, shomare_sabt="2222", phone="333333")
...
class CommentCreate(APITestCase):
    ...
    def test_create_comment(self):
        self.user14 = MyUser.objects.create_user(
            username='test 1', email='test1@test.com', password="strong_Pass")
        self.token14 = Token.objects.create(user=self.user14)
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.token14.key)
        self.sh4 = Shop.objects.create(title="shop 14", user=self.user14, manager="manager 1",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")
        self.valid_comment = {
            'user': self.user14.id,
            'text': 'comment 1',
...
class CommentListTest(APITestCase):
    ...
    def test_list_all_comment(self):
        self.user15 = MyUser.objects.create_user(
            username='test 1', email='test1@test.com', password="strong_Pass")
        self.token15 = Token.objects.create(user=self.user15)
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.token15.key)
        self.sh5 = Shop.objects.create(title="shop 15", user=self.user15, manager="manager 1",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")

        c1 = Comment.objects.create(
            user=self.user15, text="text 1", shop=self.sh5)
        c2 = Comment.objects.create(
            user=self.user15, text="text 2", shop=self.sh5)
        c3 = Comment.objects.create(
            user=self.user15, text="text 3", shop=self.sh5)

        response = self.client.get(
            reverse('CommentList', kwargs={'pk': self.sh5.pk}))
...
class CommentRetrieveUpdateDestroy(APITestCase):
    ...
    def setUp(self):
        self.user17 = MyUser.objects.create(
            username="name 17", email="test17@gmail.com", password="strong_Pass")
        self.token17 = Token.objects.create(user=self.user17)
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.token17.key)
        self.sh6 = Shop.objects.create(title="shop 17", user=self.user17, manager="manager 1",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")
        self.c4 = Comment.objects.create(
            user=self.user17, text="text 1", shop=self.sh6)
        self.c5 = Comment.objects.create(
            user=self.user17, text="text 2", shop=self.sh6)
        self.valid_comment = {
            'user': self.user17.id,
            'text': 'update_text',
            'shop': self.sh6.id
    ...
    def test_retrieve_single_comment(self):
        response = self.client.get(
            reverse('CommentRetrieveUpdateDestroy', kwargs={'pk': self.c4.pk}))
...
class RateCreate(APITestCase):
    ...
    def test_create_rate(self):
        self.user18 = MyUser.objects.create_user(
            username='test 1', email='test1@test.com', password="strong_Pass")
        self.token18 = Token.objects.create(user=self.user18)
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.token18.key)
        self.sh7 = Shop.objects.create(title="shop 18", user=self.user18, manager="manager 1",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")
        self.valid_rate = {
            'user': self.user18.id,
            'shop': self.sh7.id,
...
class RateList(APITestCase):
    ...
    def test_list_all_rate(self):
        ...
        response = self.client.get(
            reverse('RateList', kwargs={'pk': self.sh5.pk}))
...
class RateRetrieveUpdateDestroy(APITestCase):
    ...
    def test_retrieve_single_rate(self):
        response = self.client.get(
            reverse('RateRetrieveUpdateDestroy', kwargs={'pk': self.r4.pk}))
...
class TopShopList(APITestCase):
    ...
    def test_filter_top_shop(self):
        self.test_user = MyUser.objects.create_user(
            username='testcase', email='email@test.com', password="strong_Pass")

        self.sh1 = Shop.objects.create(title="shop 1", user=self.test_user, manager="manager 1",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")
        self.sh2 = Shop.objects.create(title="shop 2", user=self.test_user, manager="manager 2",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")
        self.sh3 = Shop.objects.create(title="shop 3", user=self.test_user, manager="manager 3",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111")

        self.r4 = Rate.objects.create(
            user=self.test_user, shop=self.sh1, rate=3)
        self.r4 = Rate.objects.create(
            user=self.test_user, shop=self.sh2, rate=5)
        self.r4 = Rate.objects.create(
            user=self.test_user, shop=self.sh3, rate=2)
...
class MantagheShopList(APITestCase):
    ...
    def test_filter_mantaghe_shop(self):
        ...
        self.sh1 = Shop.objects.create(title="shop 1", user=self.test_user, manager="manager 1",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111", mantaghe="1")
        self.sh2 = Shop.objects.create(title="shop 2", user=self.test_user, manager="manager 2",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111", mantaghe="2")
        self.sh3 = Shop.objects.create(title="shop 3", user=self.test_user, manager="manager 3",
                                       logo=None, address="address 1", theme=1, shomare_sabt="1111", phone="111111", mantaghe="1")
...
class TestShopCommentLike(APITestCase):
    def test_comment_of_shop_like(self):
        ...
        c = Comment.objects.create(
            user=self.user, text="test comment", shop=h)

        ###########POST####################
        response = self.client.post("/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/likes")
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.data['likes_count'], 1)
        self.assertEqual(response.data['Liked_By'][0]['username'], 'testcase')

        #########################GET#################################
        response = self.client.get("/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/likes")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class TestShopReply(APITestCase):
    def test_reply_of_shop(self):
        ...
        response1 = self.client.post(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies", data)  # 1
        self.assertEqual(response1.status_code, status.HTTP_201_CREATED)
        data = {"text": "reply test"}
        response2 = self.client.post(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies", data)  # 2
        self.assertEqual(response2.status_code, status.HTTP_201_CREATED)

        #########################GET#################################
        response = self.client.get("/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        reply = ReplySerializer(Reply.objects.get(id=response1.data['id']))
        reply2 = ReplySerializer(Reply.objects.get(id=response2.data['id']))
...
class TestShopReplyInfo(APITestCase):
    def test_reply_of_shop_info(self):
        ...
        response3 = self.client.post(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies", data)  # 3
        self.assertEqual(response3.status_code, status.HTTP_201_CREATED)

        ###########PUT####################
        data = {"text": "Update of Test"}
        response = self.client.put(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies/"+str(response3.data['id']), data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["text"], "Update of Test")
        #########################GET#################################
        response = self.client.get("/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies/"+str(response3.data['id']))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        reply = ReplySerializer(Reply.objects.get(id=response3.data['id']))
        self.assertEqual(response.data, reply.data)
        #########################DELETE#################################
        response = self.client.delete("/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies/"+str(response3.data['id']))
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
...
class TestShopReplyLike(APITestCase):
    def test_reply_of_shop_like(self):
        ...
        response4 = self.client.post(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies", data)  # 4
        self.assertEqual(response4.status_code, status.HTTP_201_CREATED)
        ###########POST####################
        response = self.client.post(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies/"+str(response4.data['id'])+"/likes", data)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.data['likes_count'], 1)
        self.assertEqual(response.data['Liked_By'][0]['username'], 'testcase')
        ...
        #########################GET#################################
        response = self.client.get(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies/"+str(response4.data['id'])+"/likes")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data[0]['likes_count'], 1)
        self.assertEqual(response.data[0]['Liked_By']
                         [0]['username'], 'testcase')
...
class TestTheLikeShop(APITestCase):
    def test_like_shop(self):
        ...
        ###########POST####################
        response = self.client.post("/api/v1/shops/"+str(h.id)+"/likes")
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.data['likes_count'], 1)
        self.assertEqual(response.data['Liked_By'][0]['username'], 'testcase')

        #########################GET#################################
        response = self.client.get("/api/v1/shops/"+str(h.id)+"/likes")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data[0]['likes_count'], 1)
        self.assertEqual(response.data[0]['Liked_By']
                         [0]['username'], 'testcase')
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data[0]['id'], h.id)
...
class TestTheReplyCommentItem(APITestCase):
    def test_reply_comment_of_item(self):
        ...
        self.data = {"text": "reply test"}
        response = self.client.post(
            "/api/v1/shops/"+str(h.id)+"/comments/"+str(c.id)+"/replies", self.data)  # 4
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)

        #########################GET#################################
        response = self.client.get(
            "/api/v1/shops/"+str(h.id)+"/commentsreplis")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data[0], CommentReplySerializer(
            Comment.objects.get(id=c.id)).data)
        self.assertEqual(len(response.data), 1)
