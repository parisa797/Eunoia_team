...
class CreateShoppingTest(APITestCase):
    ...
    def setUp(self):
        self.user1 = MyUser.objects.create_user(
            username='test 1', email='test1@test.com', password="strong_Pass", address="address 1", phone="phone 1")
...
class AllShoppingListTest(APITestCase):
    ...
    def test_list_all_shopping_list(self):
        self.user3 = MyUser.objects.create_user(
            username='test 2', email='test1@test.com', password="strong_Pass", address="address 3", phone="phone 3")
        ...
        self.assertEqual(response.data[0]['address'],
                         serializer.data[0]['address'])
...
class ShoppingListRetrieveTest(APITestCase):
    ...
    def setUp(self):
        self.user4 = MyUser.objects.create(
            username="name 4", email="zmahmoudzadeh78@gmail.com", password="password1234", address="address 1", phone="111111")
    ...
    def test_retrieve_single_shoppinglist(self):
        response = self.client.get(
            reverse('retrieve_shopping_list', kwargs={'pk': self.sl4.pk}))
        ...
        self.assertEqual(response.data['address'],
                         serializer_shoppinglist.data['address'])
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_get_invalid_shopping_list(self):
        response = self.client.get(
            reverse('retrieve_shopping_list', kwargs={'pk': 50}))
...
class ShoppingListUpdateTest(APITestCase):
    ...
    def setUp(self):
        self.user5 = MyUser.objects.create_user(
            username='test 5', email='test5@test.com', password="strong_Pass", address="address5", phone="11111111")
...
class ShopDeleteTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.sl12 = ShoppingList.objects.create(
            shop=self.sh12, user=self.user12, address="address 1", phone="111111")
...
class ShoppingListSabtTest(APITestCase):
    ...
    def setUp(self):
        self.user6 = MyUser.objects.create_user(
            username='test 6', email='test6@test.com', password="strong_Pass", address="address6", phone="66666666")
        ...
        self.sl6 = ShoppingList.objects.create(
            shop=self.sh6, user=self.user6, address="address6", phone="66666666")
...
class ShoppingListOnlineTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.user7 = MyUser.objects.create_user(
            username='test 7', email='test7@test.com', password="strong_Pass", address="address7", phone="66666666")
        ...
        self.sl7 = ShoppingList.objects.create(
            shop=self.sh7, user=self.user7, address="address7", phone="66666666")
...
class ShoppingListMaxCostTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.user14 = MyUser.objects.create_user(
            username='test 14', email='test14@test.com', password="strong_Pass", address="address14", phone="66666666")
        ...
        self.sl14 = ShoppingList.objects.create(
            shop=self.sh14, user=self.user14, address="address14", phone="66666666")
...
class CreateShoppingItemTest(APITestCase):
    ...
    def setUp(self):
        self.user8 = MyUser.objects.create_user(
            username='test 8', email='test8@test.com', password="strong_Pass", address="address 1", phone="phone 1")
        ...
        self.sl8 = ShoppingList.objects.create(
            shop=self.sh8, user=self.user8, address="address7", phone="66666666")
        self.i8 = Item.objects.create(name="item 1", description="Test description", manufacture_Date="1400-12-01",
                                      Expiration_Date="1400-12-04", count="4", price="1", discount="10", category="Dairy")
...
class AllShoppingItemTest(APITestCase):
    ...
    def test_list_all_shopping_item(self):
        self.user9 = MyUser.objects.create_user(
            username='test 9', email='test9@test.com', password="strong_Pass", address="address 9", phone="phone 3")
        ...
        self.sl9 = ShoppingList.objects.create(
            shop=self.sh9, user=self.user9, address="address7", phone="66666666")
        self.i9 = Item.objects.create(name="item 9", description="Test description", manufacture_Date="1400-12-01",
                                      Expiration_Date="1400-12-04", count="4", price="1", discount="10", category="Dairy")
        self.i10 = Item.objects.create(name="item 10", description="Test description", manufacture_Date="1400-12-01",
                                       Expiration_Date="1400-12-04", count="4", price="1", discount="10", category="Dairy")
        self.i11 = Item.objects.create(name="item 11", description="Test description", manufacture_Date="1400-12-01",
                                       Expiration_Date="1400-12-04", count="4", price="1", discount="10", category="Dairy")
        self.si9 = ShoppingItem.objects.create(
            item=self.i9, shopping_list=self.sl9, number=1)
        self.si10 = ShoppingItem.objects.create(
            item=self.i10, shopping_list=self.sl9, number=2)
        self.si11 = ShoppingItem.objects.create(
            item=self.i11, shopping_list=self.sl9, number=3)

        response = self.client.get(
            reverse('list_shopping_item', kwargs={'pk': self.sl9.pk}))
        ...
        self.assertEqual(response.data[0]['number'],
                         serializer.data[0]['number'])
        self.assertEqual(len(response.data), len(serializer.data))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class ShoppingItemUpdateTest(APITestCase):
    ...
    def setUp(self):
        self.user13 = MyUser.objects.create_user(
            username='test 13', email='test13@test.com', password="strong_Pass", address="address13", phone="11111111")
        ...
        self.sl13 = ShoppingList.objects.create(
            shop=self.sh13, user=self.user13, address="address13", phone="66666666")
        self.i13 = Item.objects.create(name="item 13", description="Test description", manufacture_Date="1400-12-01",
                                       Expiration_Date="1400-12-04", count="4", price="1", discount="10", category="Dairy")
    ...
    def test_retrieve_single_shoppingitem(self):
        ...
        self.assertEqual(response.data['number'],
                         serializer_shoppingitem.data['number'])
        self.assertEqual(response.status_code, status.HTTP_200_OK)
