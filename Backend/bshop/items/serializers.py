...
class ShopSerializer(serializers.ModelSerializer):
    class Meta:
        model = Shop
        fields = ['title', 'manager', 'logo', 'address',
                  'shomare_sabt', 'phone', 'online', 'id']
...
class ItemSerializer(serializers.ModelSerializer):
    ...
    Expiration_jalali = serializers.SerializerMethodField(
        'get_miladi_Expiration_Date')
...
class CommentLikeSerializer(serializers.ModelSerializer):
    Liked_By = UsersInfoserializer(
        source='liked_by', read_only=True, many=True)
