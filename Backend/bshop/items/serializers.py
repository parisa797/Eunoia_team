...
class ItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model= Item
        fields=['ItemShop','photo','name','shop_id','description', 'manufacture_Date','Expiration_Date','count','onlineShop','category','id']
...
class CreateListItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model= Item
        fields=['photo','name','shop_id','description', 'manufacture_Date','Expiration_Date','count','onlineShop','category','id']