...
class CommentLikeSerializer(serializers.ModelSerializer):
    Liked_By = UsersInfoserializer(source='comment_liked_by', read_only=True, many=True)
    likes_count = serializers.IntegerField(source='comment_liked_by.count', read_only=True)
    class Meta:
        model= CommentLike
...
class ReplyLikeSerializer(serializers.ModelSerializer):
    Liked_By = UsersInfoserializer(source='reply_liked_by', read_only=True, many=True)
    likes_count = serializers.IntegerField(source='reply_liked_by.count', read_only=True)
    class Meta:
        model= ReplyLike
        fields=['likes_count','Liked_By' ]

class LikeSerializer(serializers.ModelSerializer):
    Liked_By = UsersInfoserializer(source='shop_liked_by', read_only=True, many=True)
    likes_count = serializers.IntegerField(source='shop_liked_by.count', read_only=True)
    class Meta:
        model = ShopLike
        fields = ['likes_count','Liked_By']
